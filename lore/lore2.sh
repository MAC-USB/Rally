...
echo -en "\n${PROMPT} "
echo -en "Se me está enviando una información por un canal de información secundario." | pv -qL20
...
cat $DISCORD
echo -e "\n$PROMPT Se me está enviando una información por un canal de información secundario."
